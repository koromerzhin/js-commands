...
![Continuous Integration](https://github.com/koromerzhin/js-commands/workflows/Continuous%20Integration/badge.svg?branch=develop)

> Js commands for docker stack

## 🏠 [Homepage](https://github.com/koromerzhin/js-commands#readme)
...
```sh
git clone git@github.com:koromerzhin/js-commands.git js-commands
cd js-commands
```
...
Feel free to check
[issues page](https://github.com/koromerzhin/js-commands/issues).
You can also take a look at the
[contributing guide](https://github.com/koromerzhin/js-commands/blob/develop/CONTRIBUTING.md).
...
This project is
[MIT](https://github.com/koromerzhin/js-commands/blob/develop/LICENSE) licensed.
